...
namespace KurumiConcursos.Infra.Migrations
{
    ...
    [Migration("20260915134824_AddKnowledgeAreaPrivateMaterials")]
    partial class AddKnowledgeAreaPrivateMaterials
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KurumiConcursos.Domain.Entities.FlashCollection", b =>
                {
                    ...
                    b.HasIndex("UserId", "JourneyId", "KnowledgeAreaId", "SyllabusNodeId");
            ...
            modelBuilder.Entity("KurumiConcursos.Domain.Entities.QuestionAppointment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<int?>("AdaptationTrigger")
                        .HasColumnType("integer")
                        .HasColumnName("adaptation_trigger");
                    ...
                    b.HasIndex("UserId", "JourneyId", "ScheduledFor");

                    b.ToTable("question_appointment", "kurumi_concursos");
                });
            ...
            modelBuilder.Entity("KurumiConcursos.Domain.Entities.StudentProfile", b =>
                {
                    ...
                    b.Property<string>("FlashcardIntervalsJson")
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("KurumiConcursos.Domain.Entities.StudyTimerSession", b =>
                {
                    ...
                    b.Property<int>("AccumulatedFocusSeconds")
                        .HasColumnType("integer")
                        .HasColumnName("accumulated_focus_seconds");
                    ...
                    b.Property<int>("CurrentPhaseSeconds")
                        .HasColumnType("integer")
                        .HasColumnName("current_phase_seconds");
                    ...
                    b.ToTable("study_timer_session", "kurumi_concursos");
                });
            ...
            modelBuilder.Entity("KurumiConcursos.Domain.Entities.SyllabusNode", b =>
                {
                    ...
                    b.Property<string>("CognitivePairing")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("cognitive_pairing");
                    ...
                    b.Property<string>("LastStudyLocation")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("last_study_location");
            ...
            modelBuilder.Entity("KurumiConcursos.Domain.Entities.TimeCapsule", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long?>("TriggerReferenceId")
                        .HasColumnType("bigint")
                        .HasColumnName("trigger_reference_id");

                    b.Property<string>("TriggerReferenceLabel")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)")
                        .HasColumnName("trigger_reference_label");
                    ...
                    b.ToTable("time_capsule", "kurumi_concursos");
                });
            ...
            modelBuilder.Entity("KurumiConcursos.Domain.Entities.TopicMaterial", b =>
                {
                    ...
                    b.ToTable("topic_material", "kurumi_concursos");
                });
